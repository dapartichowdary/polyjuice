...
package polyjuice.scenario_3_0_1;
 ...
 * @status
 */
public class Scenario_3 implements TalendJob {
	...
	private final String jobName = "Scenario_3";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Scenario_3.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_POLYJUICE_Scenario_3 = new byte[0];
		static byte[] commonByteArray_POLYJUICE_Scenario_3 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_POLYJUICE_Scenario_3.length) {
					if (length < 1024 && commonByteArray_POLYJUICE_Scenario_3.length == 0) {
						commonByteArray_POLYJUICE_Scenario_3 = new byte[1024];
					} else {
						commonByteArray_POLYJUICE_Scenario_3 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_POLYJUICE_Scenario_3, 0, length);
				strReturn = new String(commonByteArray_POLYJUICE_Scenario_3, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_POLYJUICE_Scenario_3) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:f6pz4+Q+nos3Vcu9k26sTZ5dtidnivQRaxKJ6A==");
...
///////////////////////    			
				...
				String dbquery_tDBInput_1 = "SELECT * FROM	 account";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row1.age = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
						}
						if (colQtyInRs_tDBInput_1 < 3) {
							row1.dob = null;
						} else {

							row1.dob = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
...
///////////////////////		
						...
						if (row1.dob != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row1.dob));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Scenario_3 Scenario_3Class = new Scenario_3();

		int exitCode = Scenario_3Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Scenario_3.class.getClassLoader()
					.getResourceAsStream("polyjuice/scenario_3_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Scenario_3.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Scenario_3");
		}
...
/************************************************************************************************
 * 68063 characters generated by Talend Open Studio for Data Integration on the
 * January 22, 2021 5:06:17 PM IST
 ************************************************************************************************/