...
package polyjuice.copy_of_scenario_3_0_1;
...
/**
 * Job: Copy_of_Scenario_3 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Copy_of_Scenario_3 implements TalendJob {
	...
	private final String jobName = "Copy_of_Scenario_3";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_Scenario_3.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_Scenario_3.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbProperties_tDBConnection_1 == null || dbProperties_tDBConnection_1.trim().length() == 0) {
					url_tDBConnection_1 = "jdbc:teradata://" + context.td_host + "/DATABASE=" + "INFA";
				} else {
					url_tDBConnection_1 = "jdbc:teradata://" + context.td_host + "/DATABASE=" + "INFA" + "," + "";
				}
				String dbUser_tDBConnection_1 = context.td_user;

				final String decryptedPassword_tDBConnection_1 = context.td_pwd;
				...
				globalMap.put("host_tDBConnection_1", context.td_host);
				globalMap.put("dbname_tDBConnection_1", "INFA");
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_POLYJUICE_Copy_of_Scenario_3 = new byte[0];
		static byte[] commonByteArray_POLYJUICE_Copy_of_Scenario_3 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_POLYJUICE_Copy_of_Scenario_3.length) {
					if (length < 1024 && commonByteArray_POLYJUICE_Copy_of_Scenario_3.length == 0) {
						commonByteArray_POLYJUICE_Copy_of_Scenario_3 = new byte[1024];
					} else {
						commonByteArray_POLYJUICE_Copy_of_Scenario_3 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_POLYJUICE_Copy_of_Scenario_3, 0, length);
				strReturn = new String(commonByteArray_POLYJUICE_Copy_of_Scenario_3, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_POLYJUICE_Copy_of_Scenario_3) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:f1ylWbK8UPoV8SeZtfaJsZpEihlER2GdFa5m/w==");
...
///////////////////////    			
				...
				String dbquery_tDBInput_1 = "SELECT * from dbc";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row1.dob = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 3);
						}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Copy_of_Scenario_3 Copy_of_Scenario_3Class = new Copy_of_Scenario_3();

		int exitCode = Copy_of_Scenario_3Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_Scenario_3.class.getClassLoader()
					.getResourceAsStream("polyjuice/copy_of_scenario_3_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_Scenario_3.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Copy_of_Scenario_3");
		}
...
/************************************************************************************************
 * 69457 characters generated by Talend Open Studio for Data Integration on the
 * January 22, 2021 5:11:07 PM IST
 ************************************************************************************************/