...
package polyjuice.scenario_9_0_1;
 ...
 * @status
 */
public class Scenario_9 implements TalendJob {
	...
	private final String jobName = "Scenario_9";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Scenario_9.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_POLYJUICE_Scenario_9 = new byte[0];
		static byte[] commonByteArray_POLYJUICE_Scenario_9 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_POLYJUICE_Scenario_9.length) {
					if (length < 1024 && commonByteArray_POLYJUICE_Scenario_9.length == 0) {
						commonByteArray_POLYJUICE_Scenario_9 = new byte[1024];
					} else {
						commonByteArray_POLYJUICE_Scenario_9 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_POLYJUICE_Scenario_9, 0, length);
				strReturn = new String(commonByteArray_POLYJUICE_Scenario_9, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_POLYJUICE_Scenario_9) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:/NSRkVrDkh8//ivGr7a1Jbku5vfIyHZxtnosHw==");
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = context.td_table;
				...
				String dbname_tDBOutput_1 = (String) globalMap.get("dbname_tDBConnection_1");
				String dbUser_tDBOutput_1 = (String) globalMap.get("username_tDBConnection_1");
				...
				if (dbname_tDBOutput_1 == null || dbname_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = context.td_table;
				} else {
					tableName_tDBOutput_1 = dbname_tDBOutput_1 + "\".\"" + context.td_table;
				}
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equalsIgnoreCase((context.td_table))
								&& (schema_tDBOutput_1.equalsIgnoreCase(dbschema_tDBOutput_1)
										|| (dbschema_tDBOutput_1.trim().length() == 0
												&& dbUser_tDBOutput_1.equalsIgnoreCase(schema_tDBOutput_1)))) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE SET TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"name\" VARCHAR(255)   not null ,\"age\" INTEGER ,\"dob\" TIMESTAMP ,primary key(\"name\"))");
					}
				}
...
///////////////////////    			
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/daparti.chowdary/OneDrive - Mphasis/Desktop/Mani.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/daparti.chowdary/OneDrive - Mphasis/Desktop/Mani.csv", "ISO-8859-15", ",",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.dob = ParserUtils.parseTo_Date(temp, "MM/dd/yyyy");

								} catch (java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"dob", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
///////////////////////    			
							...
							if (row2.name == null) {
								...
								pstmt_tDBOutput_1.setString(1, row2.name);
							}
							...
							if (checkCount_tDBOutput_1 > 0) {
								if (row2.age == null) {
									...
									pstmtUpdate_tDBOutput_1.setInt(1, row2.age);
								}

								if (row2.dob != null) {
									pstmtUpdate_tDBOutput_1.setTimestamp(2, new java.sql.Timestamp(row2.dob.getTime()));
								} else {
								...
								if (row2.name == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(3 + count_tDBOutput_1, row2.name);
								}
								...
								if (row2.name == null) {
									...
									pstmtInsert_tDBOutput_1.setString(1, row2.name);
								}

								if (row2.age == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_1.setInt(2, row2.age);
								}

								if (row2.dob != null) {
									pstmtInsert_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(row2.dob.getTime()));
								} else {
					...
					if (!((Object) ("C:/Users/daparti.chowdary/OneDrive - Mphasis/Desktop/Mani.csv") instanceof java.io.InputStream)) {
...
///////////////////////    			
	...
	public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBConnection_2 = null;
				if (dbProperties_tDBConnection_2 == null || dbProperties_tDBConnection_2.trim().length() == 0) {
					url_tDBConnection_2 = "jdbc:teradata://" + context.td_host + "/DATABASE=" + context.td_db;
				} else {
					url_tDBConnection_2 = "jdbc:teradata://" + context.td_host + "/DATABASE=" + context.td_db + ","
							+ "";
				}
				String dbUser_tDBConnection_2 = context.td_user;

				final String decryptedPassword_tDBConnection_2 = context.td_pwd;
				String dbPwd_tDBConnection_2 = decryptedPassword_tDBConnection_2;

				java.sql.Connection conn_tDBConnection_2 = null;

				String driverClass_tDBConnection_2 = "com.teradata.jdbc.TeraDriver";
				...
				globalMap.put("host_tDBConnection_2", context.td_host);
				globalMap.put("dbname_tDBConnection_2", context.td_db);
				globalMap.put("username_tDBConnection_2", dbUser_tDBConnection_2);
				globalMap.put("password_tDBConnection_2", dbPwd_tDBConnection_2);
				globalMap.put("url_tDBConnection_2", url_tDBConnection_2);
	...
	public static void main(String[] args) {
		final Scenario_9 Scenario_9Class = new Scenario_9();

		int exitCode = Scenario_9Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Scenario_9.class.getClassLoader()
					.getResourceAsStream("polyjuice/scenario_9_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Scenario_9.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Scenario_9");
		}
...
/************************************************************************************************
 * 98460 characters generated by Talend Open Studio for Data Integration on the
 * January 13, 2021 5:11:33 PM IST
 ************************************************************************************************/