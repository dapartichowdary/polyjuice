...
package polyjuice.scenari_1_0_1;
 ...
 * @status
 */
public class Scenari_1 implements TalendJob {
	...
	private final String jobName = "Scenari_1";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Scenari_1.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_POLYJUICE_Scenari_1 = new byte[0];
		static byte[] commonByteArray_POLYJUICE_Scenari_1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_POLYJUICE_Scenari_1.length) {
					if (length < 1024 && commonByteArray_POLYJUICE_Scenari_1.length == 0) {
						commonByteArray_POLYJUICE_Scenari_1 = new byte[1024];
					} else {
						commonByteArray_POLYJUICE_Scenari_1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_POLYJUICE_Scenari_1, 0, length);
				strReturn = new String(commonByteArray_POLYJUICE_Scenari_1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_POLYJUICE_Scenari_1) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:/TnS1i1V5HvsB0ScClSozXPWZ1wiPfIyNjLfSg==");
				...
				Object source_tFileInputExcel_1 = "C:/Talend731/TOS_DI-Win32-20200219_1130-V7.3.1/Contextndreqfiles/context.xlsx";
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbname_tDBOutput_1 = context.td_db;
				...
				if (dbProperties_tDBOutput_1 == null || dbProperties_tDBOutput_1.trim().length() == 0) {
					url_tDBOutput_1 = "jdbc:teradata://" + context.td_host;
				} else {
					url_tDBOutput_1 = "jdbc:teradata://" + context.td_host + "/" + "";
				}
				String dbUser_tDBOutput_1 = context.td_user;

				final String decryptedPassword_tDBOutput_1 = context.td_pwd;
...
///////////////////////    			
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Talend731/TOS_DI-Win32-20200219_1130-V7.3.1/Contextndreqfiles/Mani.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Talend731/TOS_DI-Win32-20200219_1130-V7.3.1/Contextndreqfiles/Mani.csv",
...
///////////////////////    			
					...
					if (!((Object) ("C:/Talend731/TOS_DI-Win32-20200219_1130-V7.3.1/Contextndreqfiles/Mani.csv") instanceof java.io.InputStream)) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Scenari_1 Scenari_1Class = new Scenari_1();

		int exitCode = Scenari_1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Scenari_1.class.getClassLoader()
					.getResourceAsStream("polyjuice/scenari_1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Scenari_1.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Scenari_1");
		}
...
/************************************************************************************************
 * 85016 characters generated by Talend Open Studio for Data Integration on the
 * January 22, 2021 1:36:51 PM IST
 ************************************************************************************************/